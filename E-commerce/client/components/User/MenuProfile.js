			...
			<Menu>
				...
				>
					<Image
						...
						borderRadius='full'
						src={
							user.avatar ? user.avatar : 'https://placekitten.com/100/100'
						}
						alt='Cat'
					/>
				</MenuButton>
				<MenuList bgColor='#1884BE'>
					<MenuGroup title={`Hi ${user.name}`} fontSize='md'>
						<MenuItem
							icon={<FaUser size='1.2rem' />}
							_focus='blackAlpha.400'
						...
						{user.role === 'admin' ? (
							<MenuItem
								icon={<BsPersonLinesFill size='1.2rem' />}
								_focus='blackAlpha.400'
								onClick={handleAdmin}
								_hover={{ bgColor: 'blackAlpha.400' }}
							>
